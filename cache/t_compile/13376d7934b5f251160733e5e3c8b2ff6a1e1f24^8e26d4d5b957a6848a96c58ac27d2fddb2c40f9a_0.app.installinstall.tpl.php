<?php
/* Smarty version 4.5.5, created on 2026-07-14 13:52:10
  from 'app:installinstall.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_6a563f0ac67384_24247484',
...
function content_6a563f0ac67384_24247484 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_5247907736a563f0aaee510_00146283', "page");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "layouts/backend.tpl");
}
/* {block "page"} */
class Block_5247907736a563f0aaee510_00146283 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page' => 
  array (
    0 => 'Block_5247907736a563f0aaee510_00146283',
  ),
);
...
$_block_repeat=true;
echo $_block_plugin1(array('label'=>"common.language",'for'=>"installLanguage",'style'=>"position: absolute;"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo $_block_plugin1(array('label'=>"common.language",'for'=>"installLanguage",'style'=>"position: absolute;"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
?>
			...
			<?php $_block_plugin2 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0] : null;
...
$_block_repeat=true;
echo $_block_plugin2(array('id'=>"preInstallationFormArea",'title'=>"installer.preInstallationInstructionsTitle"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
			...
			<?php $_block_repeat=false;
echo $_block_plugin2(array('id'=>"preInstallationFormArea",'title'=>"installer.preInstallationInstructionsTitle"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin3(array('id'=>"administratorAccountFormArea",'title'=>"installer.administratorAccount"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin4(array('label'=>"user.username"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin4(array('label'=>"user.username"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin5(array('label'=>"user.password"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin5(array('label'=>"user.password"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin6(array('label'=>"user.repeatPassword"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin6(array('label'=>"user.repeatPassword"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin7(array('label'=>"user.email"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin7(array('label'=>"user.email"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
			<?php $_block_repeat=false;
echo $_block_plugin3(array('id'=>"administratorAccountFormArea",'title'=>"installer.administratorAccount"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>

			<!-- Locale configuration -->
			<?php $_block_plugin8 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0] : null;
...
$_block_repeat=true;
echo $_block_plugin8(array('id'=>"localeSettingsFormArea",'title'=>"installer.localeSettings"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin9(array('label'=>"locale.primary",'description'=>"installer.localeInstructions",'for'=>"locale"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin9(array('label'=>"locale.primary",'description'=>"installer.localeInstructions",'for'=>"locale"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin10(array('list'=>"true",'label'=>"installer.additionalLocales",'description'=>"installer.additionalLocalesInstructions"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
					<?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
				<?php $_block_repeat=false;
echo $_block_plugin10(array('list'=>"true",'label'=>"installer.additionalLocales",'description'=>"installer.additionalLocalesInstructions"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin11(array('label'=>"timeZone",'description'=>"installer.timezoneInstructions",'for'=>"timeZone"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin11(array('label'=>"timeZone",'description'=>"installer.timezoneInstructions",'for'=>"timeZone"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
			<?php $_block_repeat=false;
echo $_block_plugin8(array('id'=>"localeSettingsFormArea",'title'=>"installer.localeSettings"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin12(array('id'=>"fileSettingsFormArea",'title'=>"installer.fileSettings"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin13(array('label'=>"installer.filesDir",'description'=>"installer.filesDirInstructions"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
					...
					<?php $_block_repeat=false;
echo $_block_plugin13(array('label'=>"installer.filesDir",'description'=>"installer.filesDirInstructions"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin12(array('id'=>"fileSettingsFormArea",'title'=>"installer.fileSettings"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
			<?php }?>
			<!-- Database configuration -->
			<?php $_block_plugin14 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0] : null;
...
$_block_repeat=true;
echo $_block_plugin14(array('id'=>"databaseSettingsFormArea",'title'=>"installer.databaseSettings"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin15(array('label'=>"installer.databaseDriver",'description'=>"installer.databaseDriverInstructions"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin15(array('label'=>"installer.databaseDriver",'description'=>"installer.databaseDriverInstructions"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin16(array('label'=>"installer.databaseHost"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"text",'id'=>"databaseHost",'value'=>$_smarty_tpl->tpl_vars['databaseHost']->value,'maxlength'=>"100",'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM']),$_smarty_tpl ) );?>

				<?php $_block_repeat=false;
echo $_block_plugin16(array('label'=>"installer.databaseHost"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin17(array('label'=>"installer.databaseUsername"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin17(array('label'=>"installer.databaseUsername"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
				<?php $_block_plugin18 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0] : null;
...
$_block_repeat=true;
echo $_block_plugin18(array('label'=>"installer.databasePassword"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin18(array('label'=>"installer.databasePassword"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
...
$_block_repeat=true;
echo $_block_plugin19(array('label'=>"installer.databaseName"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin19(array('label'=>"installer.databaseName"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
			<?php $_block_repeat=false;
echo $_block_plugin14(array('id'=>"databaseSettingsFormArea",'title'=>"installer.databaseSettings"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>

			<?php $_block_plugin20 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0] : null;
...
$_block_repeat=true;
echo $_block_plugin20(array('id'=>"oaiSettingsFormArea",'title'=>"installer.oaiSettings"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin21(array('label'=>"installer.oaiRepositoryId",'description'=>"installer.oaiRepositoryIdInstructions"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin21(array('label'=>"installer.oaiRepositoryId",'description'=>"installer.oaiRepositoryIdInstructions"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
			<?php $_block_repeat=false;
echo $_block_plugin20(array('id'=>"oaiSettingsFormArea",'title'=>"installer.oaiSettings"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>

			<?php $_block_plugin22 = isset($_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0] : null;
...
$_block_repeat=true;
echo $_block_plugin22(array('id'=>"beaconArea",'title'=>"installer.beacon"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
$_block_repeat=true;
echo $_block_plugin23(array('list'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
				...
				<?php $_block_repeat=false;
echo $_block_plugin23(array('list'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
			<?php $_block_repeat=false;
echo $_block_plugin22(array('id'=>"beaconArea",'title'=>"installer.beacon"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
